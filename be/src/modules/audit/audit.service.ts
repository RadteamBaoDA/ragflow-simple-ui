...
export const AuditAction = {
  ...
  SET_PROJECT_PERMISSION: "set_project_permission",
  DELETE_PROJECT_PERMISSION: "delete_project_permission",
...
export const AuditResourceType = {
  ...
  DOCUMENT_CATEGORY_VERSION: "document_category_version",
    ...
    const parsedData = data.map((entry) => ({
      ...
      details:
        typeof entry.details === "string"
          ? JSON.parse(entry.details as string)
          : entry.details,
    }));
