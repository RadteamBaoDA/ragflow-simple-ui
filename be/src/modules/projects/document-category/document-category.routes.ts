...
router.get(
  "/:categoryId/versions",
  requireAuth,
  DocumentCategoryController.listVersions,
);
router.post(
  "/:categoryId/versions",
  requireAuth,
  DocumentCategoryController.createVersion,
);
router.post(
  "/:categoryId/versions/:versionId/sync",
  requireAuth,
  DocumentCategoryController.syncVersion,
);
router.put(
  "/:categoryId/versions/:versionId",
  requireAuth,
  DocumentCategoryController.updateVersion,
);
router.put(
  "/:categoryId/versions/:versionId/archive",
  requireAuth,
  DocumentCategoryController.archiveVersion,
);
router.delete(
  "/:categoryId/versions/:versionId",
  requireAuth,
  DocumentCategoryController.deleteVersion,
);
...
router.get(
  ...
  requireAuth,
  DocumentCategoryController.listDocuments,
);
router.post(
  "/:categoryId/versions/:versionId/documents",
  requireAuth,
...
router.delete(
  "/:categoryId/versions/:versionId/documents",
  requireAuth,
  DocumentCategoryController.deleteDocuments,
);
router.post(
  "/:categoryId/versions/:versionId/documents/requeue",
  requireAuth,
  DocumentCategoryController.requeueDocuments,
);
router.post(
  "/:categoryId/versions/:versionId/documents/parse",
  requireAuth,
