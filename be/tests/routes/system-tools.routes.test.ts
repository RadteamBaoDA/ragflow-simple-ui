...
describe('System Tools Routes', () => {
    ...
    describe('Module exports', () => {
        it('should export a router', async () => {
            const systemToolsRoutes = await import('../../src/modules/system-tools/system-tools.routes.js');
    ...
    describe('System tools service integration', () => {
        it('should have getEnabledTools method', async () => {
            const { systemToolsService } = await import('../../src/modules/system-tools/system-tools.service.js');
