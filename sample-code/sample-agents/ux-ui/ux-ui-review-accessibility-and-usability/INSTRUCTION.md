# Review Accessibility and Usability - Agent Instruction

## Task binding

- Role: **ux-ui**
- Task: **ux-ui-review-accessibility-and-usability**
...
- **create**: Produce a new **Produce an evidence-based accessibility and usability review** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain design or implementation artifact; target standard; user context; interaction states.
