# Create UI Specification - Agent Instruction

## Task binding

- Role: **ux-ui**
- Task: **ux-ui-create-ui-specification**
...
- **create**: Produce a new **Produce an implementation-ready UI specification** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved wireframes; design system; content; interaction rules; platform constraints.
