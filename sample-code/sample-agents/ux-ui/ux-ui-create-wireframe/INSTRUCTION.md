# Create Wireframe - Agent Instruction

## Task binding

- Role: **ux-ui**
- Task: **ux-ui-create-wireframe**
...
- **create**: Produce a new **Produce a wireframe specification suitable for review** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved flow; information architecture; content needs; platform constraints.
