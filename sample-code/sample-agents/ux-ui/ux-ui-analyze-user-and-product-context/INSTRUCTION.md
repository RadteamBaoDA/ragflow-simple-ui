# Analyze User and Product Context - Agent Instruction

## Task binding

- Role: **ux-ui**
- Task: **ux-ui-analyze-user-and-product-context**
...
- **create**: Produce a new **Produce a user and product context analysis** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain business objectives; user evidence; product analytics; support feedback; constraints.
...
1. `# Analyze User and Product Context`
