# Define Information Architecture - Agent Instruction

## Task binding

- Role: **ux-ui**
- Task: **ux-ui-define-information-architecture**
...
- **create**: Produce a new **Produce a validated information architecture** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain content inventory; user goals; domain terminology; permissions; navigation constraints.
