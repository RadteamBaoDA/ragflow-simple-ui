# Define Content and Interaction Rules - Agent Instruction

## Task binding

- Role: **ux-ui**
- Task: **ux-ui-define-content-and-interaction-rules**
...
- **create**: Produce a new **Produce consistent content and interaction rules** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain brand voice; terminology; user flow; validation rules; locale requirements.
