# Prepare Design Handoff - Agent Instruction

## Task binding

- Role: **ux-ui**
- Task: **ux-ui-prepare-design-handoff**
...
- **create**: Produce a new **Produce a versioned design handoff package** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved designs; component specifications; assets references; interaction rules; open decisions.
...
1. `# Prepare Design Handoff`
2. `## Context and Operation`
3. `## Inputs and Evidence`
4. `## Handoff Inventory`
5. `## Authoritative Versions`
6. `## Component Mapping`
7. `## Interaction Details`
8. `## Open Questions`
9. `## Review and Acceptance Plan`
