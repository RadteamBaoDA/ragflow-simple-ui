# Create CI/CD Pipeline Plan - Agent Instruction

## Task binding

- Role: **devops-sre**
- Task: **devops-sre-create-cicd-pipeline-plan**
...
- **create**: Produce a new **Produce a controlled CI/CD pipeline design** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain repository structure; build and test commands; artifact model; environments; approval policy.
