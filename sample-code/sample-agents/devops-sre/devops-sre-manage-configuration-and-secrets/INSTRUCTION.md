# Manage Configuration and Secrets - Agent Instruction

## Task binding

- Role: **devops-sre**
- Task: **devops-sre-manage-configuration-and-secrets**
...
- **create**: Produce a new **Produce a configuration and secrets management specification or change record** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain configuration inventory; environment matrix; secret owners; rotation requirements; deployment system.
