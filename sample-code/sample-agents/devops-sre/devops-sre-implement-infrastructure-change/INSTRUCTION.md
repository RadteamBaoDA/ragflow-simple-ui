# Implement Infrastructure Change - Agent Instruction

## Task binding

- Role: **devops-sre**
- Task: **devops-sre-implement-infrastructure-change**
...
- **create**: Produce a new **Produce a scoped infrastructure change with validation and rollback evidence** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved design; infrastructure state; change request; security controls; test plan.
...
1. `# Implement Infrastructure Change`
2. `## Context, Scope, and Authorization`
3. `## Inputs and Evidence`
4. `## Change Scope`
5. `## State and Dependency Impact`
6. `## Implementation`
7. `## Validation`
8. `## Rollback`
9. `## Operational Notes`
