# Assess Production Readiness - Agent Instruction

## Task binding

- Role: **devops-sre**
- Task: **devops-sre-assess-production-readiness**
...
- **create**: Produce a new **Produce an evidence-based production readiness review** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain release scope; QA and security gates; infrastructure status; observability; runbooks; support plan.
