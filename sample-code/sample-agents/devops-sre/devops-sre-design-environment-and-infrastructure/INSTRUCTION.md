# Design Environment and Infrastructure - Agent Instruction

## Task binding

- Role: **devops-sre**
- Task: **devops-sre-design-environment-and-infrastructure**
...
- **create**: Produce a new **Produce an environment and infrastructure design** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain architecture; workload; environments; security requirements; availability targets; budget constraints.
