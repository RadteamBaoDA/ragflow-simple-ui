# Manage Incident and Recovery - Agent Instruction

## Task binding

- Role: **devops-sre**
- Task: **devops-sre-manage-incident-and-recovery**
...
- **create**: Produce a new **Produce an incident action or post-incident record** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain incident signal; affected services; telemetry; ownership; recovery procedures; communication policy.
...
1. `# Manage Incident and Recovery`
