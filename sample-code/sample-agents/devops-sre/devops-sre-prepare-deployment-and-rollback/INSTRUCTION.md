# Prepare Deployment and Rollback - Agent Instruction

## Task binding

- Role: **devops-sre**
- Task: **devops-sre-prepare-deployment-and-rollback**
...
- **create**: Produce a new **Produce an executable deployment and rollback plan** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain release artifact; environment baseline; migrations; dependencies; gates; maintenance window.
...
1. `# Prepare Deployment and Rollback`
