# Define Observability - Agent Instruction

## Task binding

- Role: **devops-sre**
- Task: **devops-sre-define-observability**
...
- **create**: Produce a new **Produce an actionable observability specification** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain service objectives; architecture; failure modes; user journeys; incident process.
