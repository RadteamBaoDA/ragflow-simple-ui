# Execute Functional Testing - Agent Instruction

## Task binding

- Role: **qa**
- Task: **qa-execute-functional-testing**
...
- **create**: Produce a new **Produce a reproducible functional test execution report** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved test cases; build identity; environment baseline; test data; defect process.
