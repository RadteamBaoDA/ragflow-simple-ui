# Prepare Test Data and Environment - Agent Instruction

## Task binding

- Role: **qa**
- Task: **qa-prepare-test-data-and-environment**
...
- **create**: Produce a new **Produce a controlled test data and environment readiness record** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain test plan; data requirements; environment inventory; access; privacy constraints.
...
- Do not silently fix product code, invent requirements, accept security risk, or claim deployment or customer acceptance.
