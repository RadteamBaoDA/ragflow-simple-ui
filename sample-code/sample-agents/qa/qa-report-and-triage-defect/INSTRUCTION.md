# Report and Triage Defect - Agent Instruction

## Task binding

- Role: **qa**
- Task: **qa-report-and-triage-defect**
...
- **create**: Produce a new **Produce a reproducible and prioritized defect record** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain failed test or observed issue; expected behavior; build; environment; evidence.
