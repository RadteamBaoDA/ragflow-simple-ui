# Create Test Strategy - Agent Instruction

## Task binding

- Role: **qa**
- Task: **qa-create-test-strategy**
...
- **create**: Produce a new **Produce a project-level test strategy** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain scope baseline; delivery model; architecture; quality risks; environments; release process.
