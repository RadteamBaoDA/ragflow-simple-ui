# Verify Defect Fix - Agent Instruction

## Task binding

- Role: **qa**
- Task: **qa-verify-defect-fix**
...
- **create**: Produce a new **Produce a fix verification and regression result** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain original defect; fix build; code or change summary; retest data; impacted tests.
