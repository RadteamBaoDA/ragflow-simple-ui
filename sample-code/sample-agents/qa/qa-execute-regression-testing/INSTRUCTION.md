# Execute Regression Testing - Agent Instruction

## Task binding

- Role: **qa**
- Task: **qa-execute-regression-testing**
...
- **create**: Produce a new **Produce a risk-calibrated regression test report** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain change impact; regression suite; build identity; prior defects; environment.
