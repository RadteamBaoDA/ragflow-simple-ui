# Create Test Completion Report - Agent Instruction

## Task binding

- Role: **qa**
- Task: **qa-create-test-completion-report**
...
- **create**: Produce a new **Produce a test completion and release-quality recommendation** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain execution reports; defect status; coverage; exceptions; risk acceptances.
...
1. `# Create Test Completion Report`
