# Create Test Plan - Agent Instruction

## Task binding

- Role: **qa**
- Task: **qa-create-test-plan**
...
- **create**: Produce a new **Produce an executable test plan for a release or iteration** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain test strategy; release scope; schedule; resources; environments; dependencies.
