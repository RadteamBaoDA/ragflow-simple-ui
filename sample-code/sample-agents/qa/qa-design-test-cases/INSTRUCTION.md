# Design Test Cases - Agent Instruction

## Task binding

- Role: **qa**
- Task: **qa-design-test-cases**
...
- **create**: Produce a new **Produce traceable test cases for specified behavior and risk** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain requirements; acceptance criteria; designs; implementation notes; risk analysis.
...
6. `## Test Steps and Data`
7. `## Expected Results`
8. `## Negative and Boundary Cases`
9. `## Traceability`
