# Analyze Test Scope - Agent Instruction

## Task binding

- Role: **qa**
- Task: **qa-analyze-test-scope**
...
- **create**: Produce a new **Produce a risk-based test scope analysis** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved requirements; acceptance criteria; change inventory; architecture; known risks.
