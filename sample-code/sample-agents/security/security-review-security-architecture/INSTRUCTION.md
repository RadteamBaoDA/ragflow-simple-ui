# Review Security Architecture - Agent Instruction
...
- **create**: Produce a new **Produce an architecture-level security review** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved architecture; threat model; security requirements; data flows; control design.
