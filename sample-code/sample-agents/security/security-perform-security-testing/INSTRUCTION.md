# Perform Security Testing - Agent Instruction

## Task binding

- Role: **security**
- Task: **security-perform-security-testing**
...
- **create**: Produce a new **Produce a reproducible security test report** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain authorized scope; environment; test plan; credentials; safety constraints; build identity.
...
- Do not accept residual risk for the owner, change production, or test outside the authorized rules of engagement.
