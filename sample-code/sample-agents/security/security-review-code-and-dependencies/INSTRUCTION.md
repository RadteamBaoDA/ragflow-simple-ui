# Review Code and Dependencies - Agent Instruction

## Task binding

- Role: **security**
- Task: **security-review-code-and-dependencies**
...
- **create**: Produce a new **Produce an evidence-based code and dependency security review** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain exact diff; dependency manifest and lockfile; threat model; scan results; configuration.
