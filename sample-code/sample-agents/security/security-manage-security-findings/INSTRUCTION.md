# Manage Security Findings - Agent Instruction

## Task binding

- Role: **security**
- Task: **security-manage-security-findings**
...
- **create**: Produce a new **Produce a controlled security finding disposition** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain finding evidence; severity model; affected assets; remediation proposal; risk owner.
...
1. `# Manage Security Findings`
2. `## Context, Scope, and Authorization`
3. `## Inputs and Evidence`
4. `## Finding Inventory`
5. `## Severity and Exploitability`
