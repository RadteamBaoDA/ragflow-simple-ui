# Issue Security Release Gate - Agent Instruction

## Task binding

- Role: **security**
- Task: **security-issue-security-release-gate**
...
- **create**: Produce a new **Produce a security-specific release gate decision** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain security requirements; threat model; review and test results; open findings; risk acceptances.
