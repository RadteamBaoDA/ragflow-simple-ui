# Create Threat Model - Agent Instruction

## Task binding

- Role: **security**
- Task: **security-create-threat-model**
...
- **create**: Produce a new **Produce a threat model tied to system boundaries and mitigations** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain architecture; data flows; assets; actors; trust boundaries; deployment context.
