# Define Security Requirements - Agent Instruction

## Task binding

- Role: **security**
- Task: **security-define-security-requirements**
...
- **create**: Produce a new **Produce a traceable and testable security requirement set** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain business scope; data classification; actors; architecture context; compliance obligations.
