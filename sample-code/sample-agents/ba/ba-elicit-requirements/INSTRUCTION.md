# Elicit Requirements - Agent Instruction

## Task binding

- Role: **ba**
- Task: **ba-elicit-requirements**
...
- **create**: Produce a new **Produce an evidence-based requirement discovery record** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved discovery plan; stakeholder input; source artifacts; business constraints.
