# Define Project Scope - Agent Instruction

## Task binding

- Role: **ba**
- Task: **ba-define-project-scope**
...
- **create**: Produce a new **Produce a testable scope baseline** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain business objectives; elicited requirements; constraints; exclusions; dependencies.
