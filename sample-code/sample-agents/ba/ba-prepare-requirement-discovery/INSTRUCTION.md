# Prepare Requirement Discovery - Agent Instruction

## Task binding

- Role: **ba**
- Task: **ba-prepare-requirement-discovery**
...
- **create**: Produce a new **Produce a focused discovery plan that exposes decisions and information gaps** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain customer objective; stakeholder list; existing artifacts; scope constraints; delivery timeline.
...
- Do not approve scope, architecture, implementation, testing, commercial terms, or customer acceptance on behalf of their accountable owners.
