# Maintain Requirement Traceability - Agent Instruction

## Task binding

- Role: **ba**
- Task: **ba-maintain-requirement-traceability**
...
- **create**: Produce a new **Produce a current requirement traceability matrix** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain baselined requirements; design references; implementation items; tests; defects; approvals.
...
1. `# Maintain Requirement Traceability`
