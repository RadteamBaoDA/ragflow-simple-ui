# Analyze Business Process - Agent Instruction

## Task binding

- Role: ba
- Task: ba-analyze-business-process
...
- create: Produce a new **Produce a business process analysis with gaps and measurable outcomes** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain process owners; observed workflow; business rules; pain points; metrics.
