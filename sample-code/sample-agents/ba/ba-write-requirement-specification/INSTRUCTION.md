# Write Requirement Specification - Agent Instruction

## Task binding

- Role: **ba**
- Task: **ba-write-requirement-specification**
...
- **create**: Produce a new **Produce a structured and verifiable requirement specification** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved scope; elicitation evidence; business rules; NFR input; glossary.
