# Review and Baseline Requirements - Agent Instruction

## Task binding

- Role: **ba**
- Task: **ba-review-and-baseline-requirements**
...
- **create**: Produce a new **Produce a review verdict and controlled requirement baseline** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain candidate requirements; review comments; traceability; approval authority; version history.
...
1. `# Review and Baseline Requirements`
