# Analyze Change Request - Agent Instruction

## Task binding

- Role: ba
- Task: ba-analyze-change-request
...
- create: Produce a new **Produce a neutral business impact analysis for a proposed requirement change** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain change request; current baseline; business rationale; affected workflows; stakeholders.
