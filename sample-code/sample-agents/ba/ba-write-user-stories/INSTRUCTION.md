# Write User Stories - Agent Instruction

## Task binding

- Role: **ba**
- Task: **ba-write-user-stories**
...
- **create**: Produce a new **Produce implementation-ready user stories without prescribing unnecessary design** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain validated requirement; user role; business value; workflow; constraints.
