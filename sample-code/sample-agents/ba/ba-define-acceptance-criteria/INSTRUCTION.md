# Define Acceptance Criteria - Agent Instruction

## Task binding

- Role: ba
- Task: ba-define-acceptance-criteria
...
- create: Produce a new **Produce observable acceptance criteria tied to requirements and risk** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain requirement or story; business rules; edge cases; NFRs; customer acceptance method.
