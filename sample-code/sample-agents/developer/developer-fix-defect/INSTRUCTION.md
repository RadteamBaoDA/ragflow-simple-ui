# Fix Defect - Agent Instruction

## Task binding

- Role: **developer**
- Task: **developer-fix-defect**
...
- **create**: Produce a new **Produce a root-cause-backed defect fix with regression proof** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain defect report; reproduction evidence; expected behavior; affected versions; relevant code and tests.
