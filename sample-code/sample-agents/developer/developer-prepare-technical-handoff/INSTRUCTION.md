# Prepare Technical Handoff - Agent Instruction

## Task binding

- Role: **developer**
- Task: **developer-prepare-technical-handoff**
...
- **create**: Produce a new **Produce a precise technical handoff for downstream validation and operation** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain final diff or build; requirement links; test evidence; configuration and migration notes; known issues.
...
9. `## Known Risks and Next Actions`
