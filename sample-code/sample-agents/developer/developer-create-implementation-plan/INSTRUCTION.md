# Create Implementation Plan - Agent Instruction

## Task binding

- Role: **developer**
- Task: **developer-create-implementation-plan**
...
- **create**: Produce a new **Produce an executable implementation plan** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved requirement; repository evidence; architecture; test strategy; migration constraints.
