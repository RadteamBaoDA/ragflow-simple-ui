...
Use this variant when React, browser UI, client state, routing, accessibility, localization, or themes are affected.

## Task guidance

For **Create Implementation Plan**, map component ownership, public imports, state and error paths, accessibility, responsive and theme behavior, localization, and UI tests.
