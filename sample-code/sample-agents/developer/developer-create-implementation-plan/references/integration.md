...
Use this variant when an internal or external contract crosses system boundaries.

## Task guidance

For **Create Implementation Plan**, define contract version, authentication, timeouts, retries, idempotency, rate limits, errors, observability, and contract tests.
