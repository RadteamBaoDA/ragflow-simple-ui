...
For **Create Implementation Plan**, use the repository ORM and migration conventions; define compatibility, backfill, locks, rollback limits, integrity, and tests.
