...
Use this variant when server routes, controllers, services, policies, or background processing are affected.

## Task guidance

For **Create Implementation Plan**, map request entrypoints, validation, authorization, service boundaries, idempotency, errors, telemetry, and tests.
