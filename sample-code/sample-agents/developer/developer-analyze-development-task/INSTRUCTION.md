# Analyze Development Task - Agent Instruction

## Task binding

- Role: **developer**
- Task: **developer-analyze-development-task**
...
- **create**: Produce a new **Produce a code-aware development task analysis** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved requirement; acceptance criteria; architecture constraints; relevant code and tests; dependencies.
