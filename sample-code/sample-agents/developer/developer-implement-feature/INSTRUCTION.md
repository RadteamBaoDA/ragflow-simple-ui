# Implement Feature - Agent Instruction

## Task binding

- Role: **developer**
- Task: **developer-implement-feature**
...
- **create**: Produce a new **Produce a scoped feature implementation with reproducible evidence** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved story or specification; acceptance criteria; implementation plan; repository conventions; test commands.
