# Update Existing Feature - Agent Instruction

## Task binding

- Role: **developer**
- Task: **developer-update-existing-feature**
...
- **create**: Produce a new **Produce a controlled update that preserves unrelated behavior** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved delta; current baseline; call-chain evidence; regression tests; compatibility requirements.
