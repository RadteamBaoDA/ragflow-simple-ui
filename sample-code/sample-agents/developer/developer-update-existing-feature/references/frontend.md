...
For **Update Existing Feature**, map component ownership, public imports, state and error paths, accessibility, responsive and theme behavior, localization, and UI tests.
