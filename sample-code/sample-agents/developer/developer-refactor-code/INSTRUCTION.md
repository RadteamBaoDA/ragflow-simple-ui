# Refactor Code - Agent Instruction

## Task binding

- Role: **developer**
- Task: **developer-refactor-code**
...
- **create**: Produce a new **Produce a behavior-preserving refactor with before-and-after evidence** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain refactor objective; current tests; dependency graph; performance or maintainability evidence.
