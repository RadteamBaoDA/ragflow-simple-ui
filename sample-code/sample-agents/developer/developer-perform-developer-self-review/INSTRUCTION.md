# Perform Developer Self-review - Agent Instruction

## Task binding

- Role: **developer**
- Task: **developer-perform-developer-self-review**
...
- **create**: Produce a new **Produce a developer self-review that catches scope, correctness, and evidence gaps** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain working diff; approved requirement; architecture; test output; repository status.
...
1. `# Perform Developer Self-review`
...
6. `## Contract Check`
7. `## Test Adequacy`
8. `## Security and Performance Check`
