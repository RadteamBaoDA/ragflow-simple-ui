# Implement Integration - Agent Instruction

## Task binding

- Role: **developer**
- Task: **developer-implement-integration**
...
- **create**: Produce a new **Produce a resilient integration implementation with contract evidence** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved integration contract; credentials boundary; sandbox; failure policy; observability requirements.
