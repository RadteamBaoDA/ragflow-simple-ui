# Review Architecture Compliance - Agent Instruction

## Task binding

- Role: **solution-architect**
- Task: **solution-architect-review-architecture-compliance**
...
- **create**: Produce a new **Produce an evidence-based architecture conformance review** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved architecture; ADRs; implementation artifacts; deviations; test evidence.
