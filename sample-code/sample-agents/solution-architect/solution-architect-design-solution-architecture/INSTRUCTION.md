# Design Solution Architecture - Agent Instruction

## Task binding

- Role: **solution-architect**
- Task: **solution-architect-design-solution-architecture**
...
- **create**: Produce a new **Produce an implementation-ready solution architecture specification** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved scope; functional requirements; NFRs; current context; constraints.
