# Create Architecture Decision Record - Agent Instruction

## Task binding

- Role: **solution-architect**
- Task: **solution-architect-create-architecture-decision-record**
...
- **create**: Produce a new **Produce a durable architecture decision record** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain decision context; considered options; constraints; evidence; decision authority.
