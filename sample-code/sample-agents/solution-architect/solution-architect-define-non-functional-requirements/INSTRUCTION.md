# Define Non-functional Requirements - Agent Instruction

## Task binding

- Role: **solution-architect**
- Task: **solution-architect-define-non-functional-requirements**
...
- **create**: Produce a new **Produce a measurable non-functional requirement catalog** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain business criticality; workload; data classification; service expectations; compliance input.
