# Assess Technical Context - Agent Instruction

## Task binding

- Role: **solution-architect**
- Task: **solution-architect-assess-technical-context**
...
- **create**: Produce a new **Produce a current-state technical context assessment** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain business scope; system inventory; constraints; existing diagrams; operational evidence.
