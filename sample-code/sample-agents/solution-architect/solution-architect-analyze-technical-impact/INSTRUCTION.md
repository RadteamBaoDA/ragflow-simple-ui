# Analyze Technical Impact - Agent Instruction

## Task binding

- Role: **solution-architect**
- Task: **solution-architect-analyze-technical-impact**
...
- **create**: Produce a new **Produce a cross-layer technical impact analysis** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain proposed change; current architecture; dependencies; operational evidence; baseline contracts.
