# Design Data and Integration Contracts - Agent Instruction

## Task binding

- Role: **solution-architect**
- Task: **solution-architect-design-data-and-integration-contracts**
...
- **create**: Produce a new **Produce versioned data and integration contracts** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain domain model; source and target systems; ownership; consistency needs; security classification.
...
- Do not claim implementation, test completion, security risk acceptance, business approval, or production readiness.
...
1. `# Design Data and Integration Contracts`
2. `## Context and Operation`
3. `## Inputs and Evidence`
4. `## Data Ownership`
5. `## Schemas and Semantics`
