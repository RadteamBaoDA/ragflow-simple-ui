# Prepare Architecture Handoff - Agent Instruction

## Task binding

- Role: **solution-architect**
- Task: **solution-architect-prepare-architecture-handoff**
...
- **create**: Produce a new **Produce a consumable architecture handoff package** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved specifications; ADRs; diagrams; contracts; open decisions; implementation constraints.
...
1. `# Prepare Architecture Handoff`
