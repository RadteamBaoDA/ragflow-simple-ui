# Estimate Schedule and Budget - Agent Instruction

## Task binding

- Role: **pm**
- Task: **pm-estimate-schedule-and-budget**
...
- **create**: Produce a new **Produce an evidence-based schedule and cost estimate** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain scope decomposition; effort estimates; rate or budget constraints; calendars; contingency policy.
...
1. `# Estimate Schedule and Budget`
