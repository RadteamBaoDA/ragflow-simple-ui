# Coordinate Release and Acceptance - Agent Instruction

## Task binding

- Role: **pm**
- Task: **pm-coordinate-release-and-acceptance**
...
- **create**: Produce a new **Produce a release coordination and acceptance record** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain release scope; QA recommendation; security and operations gates; rollback plan; acceptance criteria.
...
1. `# Coordinate Release and Acceptance`
2. `## Context and Operation`
3. `## Inputs and Evidence`
4. `## Release Scope`
5. `## Gate Evidence`
6. `## Readiness Exceptions`
7. `## Deployment Window`
8. `## Acceptance Result`
