# Manage Scope and Change Requests - Agent Instruction

## Task binding

- Role: **pm**
- Task: **pm-manage-scope-and-change-requests**
...
- **create**: Produce a new **Produce a traceable scope decision and change-control record** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain scope baseline; requested change; BA and technical impact; estimate; contract constraints.
...
1. `# Manage Scope and Change Requests`
