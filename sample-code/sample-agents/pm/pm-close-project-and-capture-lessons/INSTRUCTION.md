# Close Project and Capture Lessons - Agent Instruction

## Task binding

- Role: **pm**
- Task: **pm-close-project-and-capture-lessons**
...
- **create**: Produce a new **Produce a formal closure and lessons-learned report** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain accepted deliverables; open obligations; financial status; operational handoff; stakeholder feedback.
...
1. `# Close Project and Capture Lessons`
