# Plan Project Delivery - Agent Instruction

## Task binding

- Role: **pm**
- Task: **pm-plan-project-delivery**
...
- **create**: Produce a new **Produce an executable delivery management plan** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved scope baseline; estimates; team capacity; dependencies; delivery model.
