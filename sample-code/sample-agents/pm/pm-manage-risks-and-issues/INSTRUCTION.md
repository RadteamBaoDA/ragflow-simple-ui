# Manage Risks and Issues - Agent Instruction

## Task binding

- Role: **pm**
- Task: **pm-manage-risks-and-issues**
...
- **create**: Produce a new **Produce a prioritized RAID update with owned responses** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain current RAID log; new signals; impact evidence; response owners; target dates.
