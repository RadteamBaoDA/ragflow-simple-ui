# Initiate Project - Agent Instruction

## Task binding

- Role: **pm**
- Task: **pm-initiate-project**
...
- **create**: Produce a new **Produce a controlled project charter and kickoff baseline** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain contract or statement of work; customer objectives; known stakeholders; initial constraints.
...
14. `## Status, Approval, and Handoff`
