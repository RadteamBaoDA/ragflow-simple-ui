# Track Status and Milestones - Agent Instruction

## Task binding

- Role: **pm**
- Task: **pm-track-status-and-milestones**
...
- **create**: Produce a new **Produce an evidence-backed project status report** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved plan; actual progress; milestone evidence; forecast; RAID log.
