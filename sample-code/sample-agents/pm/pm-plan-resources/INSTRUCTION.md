# Plan Resources - Agent Instruction

## Task binding

- Role: **pm**
- Task: **pm-plan-resources**
...
- **create**: Produce a new **Produce a role-based staffing and capacity plan** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain work breakdown; schedule; skills matrix; availability; location and timezone constraints.
