# Issue Merge Recommendation - Agent Instruction

## Task binding

- Role: **code-reviewer**
- Task: **code-reviewer-issue-merge-recommendation**
...
- **create**: Produce a new **Produce a concise merge gate decision** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain completed reviews; unresolved findings; test evidence; required approvals; branch status.
