# Review Architecture Conformance - Agent Instruction

## Task binding

- Role: **code-reviewer**
- Task: **code-reviewer-review-architecture-conformance**
...
- **create**: Produce a new **Produce an implementation-to-architecture conformance review** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain approved architecture; ADRs; implementation diff; dependency evidence; deviations.
...
1. `# Review Architecture Conformance`
