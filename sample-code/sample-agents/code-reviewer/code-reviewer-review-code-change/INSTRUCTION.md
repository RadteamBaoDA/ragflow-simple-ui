# Review Code Change - Agent Instruction

## Task binding

- Role: **code-reviewer**
- Task: **code-reviewer-review-code-change**
...
- **create**: Produce a new **Produce an actionable evidence-based code review** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain exact diff or commit; requirements; repository context; tests; relevant contracts.
