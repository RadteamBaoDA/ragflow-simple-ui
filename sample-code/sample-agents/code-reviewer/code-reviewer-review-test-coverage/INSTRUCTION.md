# Review Test Coverage - Agent Instruction

## Task binding

- Role: **code-reviewer**
- Task: **code-reviewer-review-test-coverage**
...
- **create**: Produce a new **Produce a behavior-focused test adequacy review** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain requirements and acceptance criteria; diff; test changes; execution output; coverage report.
...
4. `## Behavior Coverage`
5. `## Negative and Boundary Coverage`
