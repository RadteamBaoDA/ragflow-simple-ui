# Verify Review Remediation - Agent Instruction

## Task binding

- Role: **code-reviewer**
- Task: **code-reviewer-verify-review-remediation**
...
- **create**: Produce a new **Produce a finding-by-finding remediation verification** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain original review; updated diff; author responses; new test evidence; accepted exceptions.
