# Review Security and Performance - Agent Instruction

## Task binding

- Role: **code-reviewer**
- Task: **code-reviewer-review-security-and-performance**
...
- **create**: Produce a new **Produce a focused code-level security and performance review** from approved inputs; do not invent approvals or baseline facts.
...
- Obtain diff; threat or NFR inputs; data flow; dependency changes; benchmarks or profiles.
...
1. `# Review Security and Performance`
2. `## Context and Operation`
3. `## Inputs and Repository Evidence`
4. `## Security Findings`
5. `## Performance Findings`
6. `## Concurrency and Resource Findings`
7. `## Evidence Gaps`
