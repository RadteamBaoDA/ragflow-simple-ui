/**
 * @fileoverview Official RAGFlow logo as an inline SVG React component.
 * Source: https://raw.githubusercontent.com/infiniflow/ragflow/main/web/public/logo.svg
 * @module components/RagflowIcon
 */

interface RagflowIconProps {
  /** Icon size in pixels (applied to both width and height). Default: 18 */
  size?: number
  className?: string
}

/**
 * Renders the official RAGFlow logo mark as an inline SVG.
 * @param props - size and className.
 */
export function RagflowIcon({ size = 18, className }: RagflowIconProps) {
  return (
    <svg
      width={size}
      height={size}
